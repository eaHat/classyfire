...
runPerm <- function (inputData, inputClass, bootNum = 100, ensembleNum = 100, permNum=100, runParallel=TRUE, cpus=NULL, type = "SOCK", socketHosts = NULL, progressBar = TRUE) {
...
.snowRBFperm <- function(inputData, permMatr, bootNum, ensembleNum, permNum, runParallel, cpus, type, socketHosts, progressBar)
{
  ...
  {
    stop("The Rmpi package has not been loaded. Please try again.")
  }
}